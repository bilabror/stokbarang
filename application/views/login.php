    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/logo.jpeg'); ?>" class="login" />
                <h3 class="text-white mt-2">Aplikasi Persediaan Barang Koperasi KONI Salatiga</h3>
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                ...
                <p class="text-white text-center">Copyright &copy;<script>
                        'ardinnalilaagustin'(new Date().getFullYear());
                    </script> ardinnalilaagustin
                </p>
            </div>
        </div>
    </div>
