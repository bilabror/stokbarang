...
<div class="alert alert-info" role="alert">
    ...
    <hr>
    <h4 class="alert-heading"><i class="fa fa-info-circle"></i> Selamat Datang di <b>Sistem Informasi Persediaan Barang</b></h4>
    <p class="mb-5" style="font-size: 16px;">Anda login sebagai <b><?= $this->session->userdata('User'); ?></b> dengan level <b><?= ucfirst($this->session->userdata('level')); ?></b></p>
</div>