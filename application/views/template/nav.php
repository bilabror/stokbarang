...
<nav id="sidebar">
    <div class="p-6 pt-10">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/logo.jpeg'); ?>);"></a>
        <ul class="list-unstyled components mb-10">
            ...
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['saldo_akhir'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('saldo_akhir'); ?>"><i class="fa fa-cubes"></i> Saldo Akhir</a>
            </li>

            <li <?= (in_array(strtolower($this->uri->segment(1)), ['pegawai', 'tambah_pegawai', 'edit_pegawai'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('pegawai'); ?>"><i class="fa fa-users"></i> Data User</a>
            </li>
            ...
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['kartu_stok_barang'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('kartu_stok_barang'); ?>"><i class="fa fa-reply"></i> Kartu Stok Barang</a>
            </li>

            <li <?= (in_array(strtolower($this->uri->segment(1)), ['kartu_persediaan_barang'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('kartu_persediaan_barang'); ?>"><i class="fa fa-reply"></i> Kartu Persediaan Barang</a>
            </li>
