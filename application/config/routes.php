...
//route stok ahkir
$route['stok_ahkir'] = 'stok_ahkir/index';
$route['ajax_stok_ahkir'] = 'stok_ahkir/ajax_barang';
...
//router kartu stok
$route['kartu_stok'] = 'laporan/kartu_stok';
...
$route['hapus_saldoakhir'] = 'saldo_akhir/hapus_data';
